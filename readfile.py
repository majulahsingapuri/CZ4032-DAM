...
def readfile(data_path, scheme_path):
...
if __name__ == '__main__':
    ...
    test_data_path = 'D:/notes/Y3S1/CZ4032 (Data Analytics and Mining)/Assignment 1/CBA-master/datasets/iris.data'
    test_scheme_path = 'D:/notes/Y3S1/CZ4032 (Data Analytics and Mining)/Assignment 1/CBA-master/datasets/iris.names'
    test_data, test_attributes, test_value_type = read(test_data_path, test_scheme_path)
    result_data = preprocessing.pre_process(test_data, test_attributes, test_value_type)
    print(result_data)
